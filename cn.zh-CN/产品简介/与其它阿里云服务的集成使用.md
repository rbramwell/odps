...
-   通过DataWorks配置数据同步任务，[读MaxCompute](https://help.aliyun.com/document_detail/49813.html)和[写AnalyticDB for MySQL](https://help.aliyun.com/document_detail/49821.html)。
...
[RAM](../../../../cn.zh-CN/产品简介/什么是RAM.md#)是阿里云为客户提供的用户身份管理与资源访问控制服务。MaxCompute与RAM的集成使用主要有两个场景：
