...
-   SDK：
    ...
    -   [Java SDK](../../../../intl.zh-CN/SDK参考/Java SDK.md)：向开发者提供Java接口。
...
-   [SQL开发限制](../../../../intl.zh-CN/开发/SQL及函数/SQL概述.md#section_zrv_jcm_sfb)
...
-   [安全配置限制](../../../../intl.zh-CN/管理/安全功能详解/目标用户.md#section_xng_nhn_sfb)
