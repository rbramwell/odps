...
``` {#codeblock_fws_kk5_ct8 .language-java}
...
文中给出的是华东2经典网络Tunnel Endpoint，其他region的Tunnel Endpoint设置可以参考文档[配置Endpoint](../../../../cn.zh-CN/准备工作/配置Endpoint.md#)。
...
``` {#codeblock_hes_ni4_dng .language-java}
...
``` {#codeblock_0z9_h78_7gy .language-java}
Odps odps = OdpsUtils.newDefaultOdps(); //初始化Odps对象。
    Instance i = SQLTask.run(odps, "select * from wc_in;");
    i.waitForSuccess();
