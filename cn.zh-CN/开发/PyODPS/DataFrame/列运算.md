...
## 使用自定义函数 {#section_peu_fs4_uh8 .section}
...
目前，第三方库（包含C）只能使用numpy，第三方库使用详情请参见[使用第三方Python库](http://pyodps.alibaba.net/pyodps-docs/zh-CN/latest/df-element.html#third-party-library)。
