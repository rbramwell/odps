...
2.  准备好多路输入输出的测试表和资源。
    ...
    -   添加测试资源。
        ...
        ``` {#codeblock_sid_vny_76z}
        add jar data\resources\mapreduce-examples.jar -f;
        ```

3.  使用Tunnel导入数据。

    ``` {#codeblock_w7j_lkt_20t}
    ...
    ``` {#codeblock_lzu_yg6_97h}
     hello,odps
    ```

    导入wc\_in2表的数据文件data的内容。

    ``` {#codeblock_lii_web_wnc}
     hello,world
    ```
